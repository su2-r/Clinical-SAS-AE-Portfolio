...
- **Summary Tables & Listings (`TFLs`):** Output reports including Adverse Event frequency tables, treatment-emergent summary reports, and subject listings.
- **Validation Reports:** Double-programming reconciliation reports for Quality Control (QC).
